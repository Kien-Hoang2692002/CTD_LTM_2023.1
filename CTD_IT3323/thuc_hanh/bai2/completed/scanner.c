...
extern int lineNo; // so dong hien tai
extern int colNo; // so cot hien tai
extern int currentChar; // ky tu hien tai

extern CharCode charCodes[];

/***************************************************************/

// Ham bo qua khoang trang va di chuyen den ki tu khac
void skipBlank() {
...
// Ham doc identifier hoac keywork 
  ...
  if(currentChar == EOF){
    ...
    switch(charCodes[currentChar]) {
      case CHAR_SINGLEQUOTE:
        ...
        // Neu ki tu tiep theo la ''' -> co the la ky tu hang rong
        if(charCodes[currentChar] == CHAR_SINGLEQUOTE) { 
          token->string[0] = currentChar;

          readChar();
          
           // Neu ki tu tiep theo la ''' -> hang ki tu la '
          if(charCodes[currentChar] == CHAR_SINGLEQUOTE) { 
            token->string[1] = '\0';
            return token;
          } else {
        ...
        } else { // TH: '' -> khong co hang ki tu
          error(ERR_INVALIDCHARCONSTANT, token->lineNo, token->colNo);
        }
        break;
      default: 
        // cac truong hop khong co tu 2 dau ' lien tiep -> ki tu tiep theo la ky tu hang 
        token->string[0] = currentChar;
